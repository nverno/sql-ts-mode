...
CREATE TYPE cities AS (cityname text, population INTEGER);
...
ALTER TYPE boxes RENAME ATTRIBUTE width TO height;


ALTER TYPE boxes OWNER TO user2 ;
...
ALTER TYPE boxes RENAME VALUE 'weight' TO 'mass' ;


ALTER TYPE boxes ADD ATTRIBUTE label text ;
...
CREATE TABLE shipments (shipment boxes);
